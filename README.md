...
"喂！星"是一个"人人都能拥有一颗私人卫星"的交互式产品原型。用户拥有一颗运行在真实近地轨道上的虚拟私人卫星，可以用自然语言指挥它拍照、反射阳光、与 AI 对话，甚至用鸿蒙手机实时遥控它的姿态。

它不只是一个 Demo，而是一份关于"太空基础设施平民化"的完整技术验证和产品想象。
...
我们生活在一个割裂的时代。太空算力、对地观测、太阳光反射这三件事，每一件都已经在现实中被验证过，但它们从来没有被整合在一起，更没有被交到普通人手里。我们相信太空应该属于所有人，而不是少数机构的特权。

"喂！星"要做的事情是：把三件已被验证的能力，第一次用"自然语言 + 手机遥控"的方式，交到每一个普通人手里。
...
2026 年，是个人卫星从梦想变成基础设施的元年。

---

## 我们的团队

北大 x 清华 x 开源社区 x 独立开发者。四个刚好的人，做一件刚好的事。

| 成员 | 背景 | 方向 |
|------|------|------|
| 邵瑞琪 | 清华 NLP | AI 交互产品，从 0 到 1 主导 |
| 曹阳 | 智源 · 基模 | 全栈开发，开源作者，曾获李开复、雷军等知名投资人认可 |
| 朱利戈 | 北大直博，强化学习 | AI4S 方向，AISI 实习 |
| 王宇 | 科技博主 | AI Agent 方向，独立产品开发，科技内容创作者 |

48 小时内完成双端联动，从概念到可演示产品。
...
1. **个人订阅**：基础版免费（虚拟卫星体验），Pro 版接入真实卫星数据与优先任务队列。
2. **企业/活动定制**：婚礼、演唱会、品牌活动的太空照明定制服务，对标无人机表演的下一代形态。
3. **开发者生态**：卫星 API 开放平台，第三方应用通过 Energy Points 计费调用，类比 AWS Lambda 到 Space Lambda。

### 市场验证

产品零推广，两天内社群自然增长，需求真实存在。
...
**主控台**：核心交互页面。全屏三维地球、真实轨道上运行的卫星、电影级开场动画、AI 对话窗口、实时遥测面板、任务照片查看器。打开网页就像打开了一个属于自己的太空控制中心。
...
Powered by "喂！星" Satellite System
